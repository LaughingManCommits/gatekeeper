...
import com.gate.keeper.service.CookieService;
import com.gate.keeper.service.SessionService;
import com.gate.keeper.service.UserService;
...
public class SessionCookieSecurityContextRepository implements SecurityContextRepository {
    ...
    public boolean containsContext(HttpServletRequest request) {
        ...
        String cookieValue = cookieService.getCookieValue(request, SESSION_COOKIE);
