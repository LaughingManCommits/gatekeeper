...
For example when requesting any content behind the URI "/Level1/**", the request will validated and blocked when the atteched session does not have the required access level. 
